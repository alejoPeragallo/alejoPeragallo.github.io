* {
  ...
  .imagenMedianaEstatica, .imagenMedianaEstaticaB {
    height: 300px;
    width: 300px;
    margin-left: 10px;
    margin-top: 5px;
  ...
  @media (max-width: 1024px) {
    ...
    .imagenMedianaB, .imagenMedianaEstaticaB {
      width: 460px;
    }
  ...
  @media (max-width: 768px) {
    .imagenGrande, .imagenGrandeEstatica {
      height: 360px;
      width: 350px;
      object-fit: cover;
    }
